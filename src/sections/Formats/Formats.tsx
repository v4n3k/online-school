...
const FORMATS = [
  {
    title: "Только один на один",
    desc: "Никаких групп. Занятие полностью под вашего ребёнка: его темп, его вопросы, его прогресс.",
    icon: (
  ...
  },
  {
    ...
    desc: "Один час, чтобы разобрать новую тему, закрепить её на практике и ответить на вопросы.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
  ...
  },
  {
    ...
    desc: "Программа под уровень и цель: от «закрыть пробелы» до подготовки к олимпиадам.",
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8">
        <path d="M12 3l1.8 4.7 4.7 1.8-4.7 1.8L12 16l-1.8-4.7-4.7-1.8 4.7-1.8L12 3Z" strokeLinejoin="round" />
