...
const FEATURES = [
	{
		...
		text:
			'Программа строится строго под вашего ребёнка: его темп, его пробелы, его цель.',
		icon: (
			<svg
				viewBox='0 0 24 24'
				fill='none'
	...
	},
	{
		...
		text:
			'После каждого месяца присылаем разбор прогресса: что получилось и над чем работаем дальше.',
		icon: (
			<svg
				viewBox='0 0 24 24'
				fill='none'
	...
	},
	{
		...
		text:
			'Онлайн-платформа с интерактивной доской и записями уроков, которые пересматриваются сколько нужно.',
		icon: (
			<svg
				viewBox='0 0 24 24'
				fill='none'
	...
	},
	{
		...
		text:
			'Тренировочные ОГЭ в реальных условиях — чтобы на настоящем экзамене не было стресса.',
		icon: (
			<svg
				viewBox='0 0 24 24'
				fill='none'
